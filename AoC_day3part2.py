#wire1=['R7','D3','R8','U8','L1','D4','R7','U7','L7']
#wire2=['U6','R6','U5','R4','D7','R5','D5','R3']s
...
def stepcounter(point,wire):
    return wire.index(point)
wire_set1 = path(wire1)
wire_set2 = path(wire2)
x_set = set(wire_set1) & set(wire_set2)
print(x_set)
x_set.remove((0,0))
steps_list = []
for x in x_set:
    sum = stepcounter(x,wire_set1) + stepcounter(x,wire_set2)
    steps_list.append(sum)
